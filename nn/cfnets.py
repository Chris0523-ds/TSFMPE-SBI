...
from nn.enets import create_enet_with_projection_layer_and_dense_resnet
from typing import Union, Callable

from nn.enets import DenseResidualNet
...
class ContinuousFlowModel(nn.Module):
    ...
    def forward(self, t, theta, *context):
        ...
        if self.context_with_glu and self.theta_with_glu:
            ...
            #print(f"context_embedding device: {context_embedding.device}")
            #print(f"t_and_theta_embedding device: {t_and_theta_embedding.device}")
